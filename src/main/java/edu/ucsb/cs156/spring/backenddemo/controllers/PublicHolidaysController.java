...
public class PublicHolidaysController {
    ...
    @Operation(summary="Get public holidays for a given year and country", description ="Public Holiday Data is uploaded date.nager.at/Api")
    @GetMapping("/get")
    public ResponseEntity<String> getPublicHolidays(
        @Parameter(name="year", example="2020") @RequestParam String year,
